...
public sealed partial class MainLayout
{
    private readonly MudTheme _theme = new()
    {
        ...
        {
            Primary = ClientAppConfiguration.ColorPaletteLightPrimary,
            AppbarBackground = ClientAppConfiguration.ColorPaletteLightAppbarBackground,
            Secondary = ClientAppConfiguration.ColorPaletteLightSecondary
        },
    ...
    [Inject] public required ClientApp.Services.ILocalStorageService LocalStorage { get; set; }
    ...
    private string LogoImagePath
    {
        get
        {
            return ClientAppConfiguration.LogoImagePath;
        }
    }
    ...
    private int LogoImageWidth
    {
        get
        {
            return ClientAppConfiguration.LogoImageWidth;
        }
    }
