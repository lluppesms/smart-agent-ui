...
public record class VoicePreferences
{
    ...
    private readonly ClientApp.Services.ILocalStorageService _storage;

    public VoicePreferences(ClientApp.Services.ILocalStorageService storage) => _storage = storage;
